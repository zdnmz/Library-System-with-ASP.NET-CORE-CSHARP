                    ...
                    <table class="tbl">
                        ...
                        <tr>
                            <td style="border-top: 2px solid white; border-bottom: thin solid #FFF; font-weight: 700;" 
                                class="style13">
                                Kitabı Alacak Öğrencinin Bilgileri&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td class="style15">
                                ...
                                &nbsp;Günler :<asp:TextBox ID="TextBox1" runat="server" CssClass="txt" Width="50px"></asp:TextBox>
&nbsp;<asp:Button ID="btnissue" runat="server" CssClass="btn" onclick="btnissue_Click" Text="Kitabı Ver" 
                                    Width="100px" />
                            </td>
                        </tr>
                    </table>
