...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btntaken" runat="server" CssClass="btn" Text="KITAP ODUNC AL" 
                    onclick="btntaken_Click" />
&nbsp;<asp:Button ID="btnreturn" runat="server" CssClass="btn" Text="KITABI IADE ET" 
                                ...
                                <td>
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="returndate" HeaderText="Iade Tarihi" />
                                        </Columns>
                                        <FooterStyle BackColor="Tan" />
                                        <HeaderStyle BackColor="#C1C1C1" Font-Bold="True" />
                                        <PagerStyle BackColor="PaleGoldenrod" ForeColor="DarkSlateBlue" 
