        ...
        <td align="center">
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="panalty" HeaderText="Ceza Tutarı">
                    <ItemStyle Width="110px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="detail" HeaderText="Ayrıntı" />
                    <asp:BoundField DataField="entrydate" HeaderText="Tarih" />
                </Columns>
